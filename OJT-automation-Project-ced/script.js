...
function loadReport(skipInit) {
    ...
    const rows = currentEditablePrograms.map((program, index) => `
        <tr>
            ...
            <td><input type="number" id="ab_ps_${index}" min="0" step="0.01" value="${program.annualBudget?.ps || 0}" oninput="saveBudget(${index});calculate(${index})" aria-label="Annual Budget PS" class="input-number"></td>
            <td><input type="number" id="ab_mooe_${index}" min="0" step="0.01" value="${program.annualBudget?.mooe || 0}" oninput="saveBudget(${index});calculate(${index})" aria-label="Annual Budget MOOE" class="input-number"></td>
            <td><input type="number" id="ab_co_${index}" min="0" step="0.01" value="${program.annualBudget?.co || 0}" oninput="saveBudget(${index});calculate(${index})" aria-label="Annual Budget CO" class="input-number"></td>
            <td><input type="number" id="ab_total_${index}" min="0" step="0.01" value="${program.annualBudget?.total || 0}" oninput="saveBudget(${index});calculate(${index})" aria-label="Annual Budget Total" class="input-number"></td>
...
function loadAnnualFinancialPerformance(skipInit) {
    ...
    const rows = currentEditablePrograms.map((program, index) => `
        <tr>
            ...
            <td><input type="number" id="aip_mooe_${index}" min="0" step="0.01" value="${program.aipAmount?.mooe || 0}" aria-label="AIP MOOE" class="input-number" readonly></td>
            <td><input type="number" id="aip_co_${index}" min="0" step="0.01" value="${program.aipAmount?.co || 0}" aria-label="AIP CO" class="input-number" readonly></td>
            <td><input type="number" id="ab_ps_${index}" min="0" step="0.01" value="${program.annualBudget?.ps || 0}" oninput="saveBudget(${index});calculateAnnualFinancial(${index})" aria-label="Annual Budget PS" class="input-number"></td>
            <td><input type="number" id="ab_mooe_${index}" min="0" step="0.01" value="${program.annualBudget?.mooe || 0}" oninput="saveBudget(${index});calculateAnnualFinancial(${index})" aria-label="Annual Budget MOOE" class="input-number"></td>
            <td><input type="number" id="ab_co_${index}" min="0" step="0.01" value="${program.annualBudget?.co || 0}" oninput="saveBudget(${index});calculateAnnualFinancial(${index})" aria-label="Annual Budget CO" class="input-number"></td>
            <td><input type="number" id="ab_total_${index}" min="0" step="0.01" value="${program.annualBudget?.total || 0}" oninput="saveBudget(${index});calculateAnnualFinancial(${index})" aria-label="Annual Budget Total" class="input-number"></td>
